      ...
      {activeTab === 'operations' && (
        <>
          <Card className="dashboard-rise-up">
            <CardHeader>
              <CardTitle className="text-lg">Operations Overview by Location</CardTitle>
              <CardDescription>Choose a site to view only its operational graphics and KPIs.</CardDescription>
            </CardHeader>
            <CardContent>
